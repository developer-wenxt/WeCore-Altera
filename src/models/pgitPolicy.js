module.exports = (sequelize, DataTypes) => {
  const PgitPolicy = sequelize.define('PgitPolicy', {
   ...
   POL_CP_DAYS: { 
    ...
    ,
   POL_NOTICE_SUPPRESS_YN: { 
      type: DataTypes.STRING(1), 
      allowNull: true, 
      
      field: 'POL_NOTICE_SUPPRESS_YN' 
    }
    ,
   POL_PML_PERC: { 
      type: DataTypes.DECIMAL(8, 5), 
