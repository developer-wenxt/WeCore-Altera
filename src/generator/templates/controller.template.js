const ${camelCase}Service = require('../services/${camelCase}Service');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await ${camelCase}Service.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await ${camelCase}Service.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await ${camelCase}Service.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await ${camelCase}Service.deleteItem(req.params.id);
