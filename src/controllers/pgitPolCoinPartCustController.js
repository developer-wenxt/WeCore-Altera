const pgitPolCoinPartCustService = require('../services/pgitPolCoinPartCustService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitPolCoinPartCustService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitPolCoinPartCustService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitPolCoinPartCustService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitPolCoinPartCustService.deleteItem(req.params.id);
