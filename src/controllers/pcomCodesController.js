const pcomCodesService = require('../services/pcomCodesService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pcomCodesService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pcomCodesService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pcomCodesService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pcomCodesService.deleteItem(req.params.id);
