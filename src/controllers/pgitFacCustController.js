const pgitFacCustService = require('../services/pgitFacCustService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitFacCustService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitFacCustService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitFacCustService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitFacCustService.deleteItem(req.params.id);
...
exports.getByPolSysId = async (req, res, next) => {
  try {
    ...
    const result = await pgitFacCustService.getByPolSysId(Number(fcFpsSysId));
