const pgitPolScheduleService = require('../services/pgitPolScheduleService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitPolScheduleService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitPolScheduleService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitPolScheduleService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitPolScheduleService.deleteItem(req.params.id);
