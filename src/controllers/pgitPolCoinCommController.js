const pgitPolCoinCommService = require('../services/pgitPolCoinCommService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitPolCoinCommService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitPolCoinCommService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitPolCoinCommService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitPolCoinCommService.deleteItem(req.params.id);
