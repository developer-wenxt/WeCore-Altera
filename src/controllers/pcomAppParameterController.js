const pcomAppParameterService = require('../services/pcomAppParameterService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pcomAppParameterService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pcomAppParameterService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pcomAppParameterService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pcomAppParameterService.deleteItem(req.params.id);
