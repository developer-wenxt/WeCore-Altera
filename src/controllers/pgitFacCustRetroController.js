const pgitFacCustRetroService = require('../services/pgitFacCustRetroService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitFacCustRetroService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitFacCustRetroService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitFacCustRetroService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitFacCustRetroService.deleteItem(req.params.id);
